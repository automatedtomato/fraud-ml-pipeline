...
def train_models(
    ...
    """
    val_sampl_df = pd.read_sql(val_sample_query, engine, parse_dates=["trans_ts"])
    ...
    for model_name, model in models_to_train.items():
        ...
        if strategy == "incremental":
            ...
            logger.info(
                f"Loading {batch_train_sample_size} random samples from training data for batch training of '{model_name}'..."
            )
